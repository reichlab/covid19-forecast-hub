...
if (plot_all_historical_as_ofs) {
  first_as_of_dates <- data.frame(
    ...
    first_as_of_date = as.Date(c("2021-04-04", "2021-04-04", "2021-04-04"))
  )
} else {
  first_as_of_dates <- data.frame(
    measure = c("cases", "hospitalizations", "deaths"),
...
for (measure in c("cases", "hospitalizations", "deaths")) {
  ...
  # pdf(paste0("data-truth/plots_", measure, "2021_April.pdf"), width = 14, height = 9)
  pdf(paste0("plots_", measure, "2021_April.pdf"), width = 14, height = 9)
