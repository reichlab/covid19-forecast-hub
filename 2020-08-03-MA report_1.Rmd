...
dat <- zoltr:: do_zoltar_query(
  ...
  units=c("01003","US","25","25001","25003","25005","25007","25009","25011","25013","25015","25017","25019","25021"),
...
datatable(wide_point_dat %>% 
  ...
  caption = 'Table 1: US national and state-level observed deaths to date and for the previous two weeks (ending August 1, 2020) with forecasted COVID-19 deaths for the next two weeks (ending August 15, 2020).',
  options = list(
    autoWidth = TRUE,
...
wide_point_dat1 <- spread(ensemble_pointdat1, target, value) %>%
  ...
  select(location_name, Population, cum_cases_at_forecast_start,
    ...
    diff_2wk_cases_rate, diff_4wk_cases_rate, next_2wk_inc_cases)
...
datatable(wide_point_dat %>% 
  ...
  caption = 'Table 2: County -level observed and predicted daily death rates for the previous two weeks (ending July 25, 2020) and the next two weeks (ending August 8, 2020).',
  options = list(
    autoWidth = TRUE,
    columnDefs = list(list(width = '100px', targets = c(0, 1, 2, 3, 4, 5)))
  ),  #width=paste0(c(10, 100, 100, 100), 'px'),
