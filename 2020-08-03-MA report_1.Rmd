...
dat <- zoltr:: do_zoltar_query(
  ...
  units=c("US","25","25001","25003","25005","25007","25009","25011","25013","25015","25017","25019","25021"),
...
datatable(wide_point_dat1 %>% 
  ...
  caption = 'Table 2: County level observed and predicted daily case rates for the previous two weeks (ending July 25, 2020) and the next two weeks (ending August 8, 2020).',
  options = list(
    autoWidth = TRUE,
    columnDefs = list(list(width = '100px', targets = c(0, 1, 2, 3, 4, 5)))
  ),  #width=paste0(c(10, 100, 100, 100), 'px'),
