...
cum_filename <- paste0("data-raw/LANL/", most_recent_date, "_deaths_quantiles_us_website.csv")
inc_filename <- paste0("data-raw/LANL/", most_recent_date, "_deaths_incidence_quantiles_us_website.csv")
