...
Every week, we combine the most recent forecasts from each team into a single "ensemble" forecast of reported COVID-19 cases and deaths in upcoming weeks. At the moment, we only generate ensemble forecasts for four weeks into the future, as we don't have reliable evidence that the models are accurate past that horizon.
...
datatable(wide_point_dat %>% 
    select(location_name, Population,
      ...
      last_2wk_deaths, next_2wk_deaths, diff_2wk_deaths),
  caption = 'Table 1: US national and state-level observed and predicted daily deaths for the previous two weeks (ending July 25, 2020) and the next two weeks (ending August 8, 2020).',
  options = list(
    autoWidth = TRUE,
