...
inc_case_forecast_p6_c<-load_forecasts(models=c("COVIDhub-ensemble"),forecast_dates =last_6_mondays,locations =county,  types = c("quantile"),targets = c(inc_case_targets),  verbose = FALSE)
...
table2_cap <- paste0("Table 2:",  state_name, " county level observed and predicted COVID-19 cases for the previous week  and two weeks ahead.")
