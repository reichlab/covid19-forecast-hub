...
Each Monday evening or Tuesday morning, we combine the most recent forecasts from each team into a single "ensemble" forecast of reported COVID-19 cases at the county, state, and national level and deaths at the state and national level. At the moment, we only generate ensemble forecasts for up to four weeks into the future, as  <a href="https://www.medrxiv.org/content/10.1101/2021.02.03.21250974v1" target="_blank">the available evidence</a> suggests that models are less accurate at longer forecast horizons.
