...
ens_preds <- readRDS("./data-raw/Imperial/20200419-ensemble_model_predictions.rds")
...
colMeans(ens_preds$`2020-04-19`$United_States_of_America[[1]])
...
imperial_forecast_dates <- tibble(
    ...
    raw_forecast_date = as.Date("2020-04-19"),
