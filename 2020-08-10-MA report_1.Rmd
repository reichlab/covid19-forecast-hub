...
wide_point_dat2 <- spread(ensemble_pointdat2, target, value) %>%
  ...
  mutate(next_2wk_cases = `2 wk ahead inc case` + `1 wk ahead inc case`,
    diff_2wk_cases = next_2wk_cases - last_2wk_cases,
    next_4wk_cases = `4 wk ahead inc case` + `3 wk ahead inc case` + next_2wk_cases,
...
Low_MA_counties <- c("25001","25003","25007","25011","25015","25019")    
