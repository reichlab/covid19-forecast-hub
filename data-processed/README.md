...
- "# day ahead cum death" where # is 1-130
- "# day ahead inc death" where # is 1-130
- "# wk ahead cum death"  where # is 1-20
- "# wk ahead inc death"  where # is 1-20
- "# day ahead inc hosp"  where # is 1-130
...
and including # weeks after `forecast_date`. 

##### # wk ahead inc death

This target is the incident (weekly) number of deaths predicted by the model 
during the week that is # weeks after `forecast_date`. 
...
- "US" or
- # where # represents the US state, territory, or district 
...
The intent for these tests are to test the requirements above and 
...
if we are missing tests on this wiki.
...
prior to submission to ensure the data will validate. 
